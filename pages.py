# pages.py  -  Pshtiwan Gateway v9.2
...
<title>ورود · Pshtiwan Gateway</title>
...
<div class="wrap">
  <div class="card">
    <div class="brand">
      <div class="brand-img"><img src="https://yt3.googleusercontent.com/vA6bYj1V386YmibpWRNFJtsRRqwfY_U9wnb7gmW90eRVXyNB7gAfjj1XPs5UX0cdKdQprrI=s160-c-k-c0x00ffffff-no-rj" alt="Pshtiwan"></div>
      <div><div class="brand-name">Pshtiwan</div><div class="brand-sub">Pshtiwan Gateway · v9.2</div></div>
    </div>
    <h1>ورود به پنل</h1>
    ...
    <div class="footer">ارتباط<a href="https://t.me/pshaka123" target="_blank"><i class="ti ti-brand-telegram"></i>@pshaka123</a></div>
  </div>
</div>
<script>
...
<div class="mob-top">
  <div class="ml">
    ...
    <span class="mob-title">Pshtiwan Gateway</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    ...
    <div><div class="logo-name">Pshtiwan</div><div class="logo-sub">Pshtiwan Gateway · v9.2</div></div>
  </div>
  <div class="nav-wrap">
  ...
  <div class="sb-foot">
    ...
    <a class="tg-btn" href="https://t.me/pshaka123" target="_blank" rel="noopener"><i class="ti ti-brand-telegram"></i> @pshaka123</a>
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text"> Pshtiwan Gateway v9.2 · Railway · 2025</span>
    <a class="df-link" href="https://t.me/pshaka123" target="_blank"><i class="ti ti-brand-telegram"></i> t.me/pshaka123</a>
  </div>
</section>
...
<title>Pshtiwan Sub · Pshtiwan</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
...
<div class="wrap">
  <div class="top">
    ...
    <div class="top-actions">
      ...
      <a class="icon-btn" href="https://t.me/pshaka123" target="_blank" title="کانال تلگرام"><i class="ti ti-brand-telegram"></i></a>
    </div>
  </div>
  <div id="root">
    <div class="empty-state"><i class="ti ti-loader-2" style="animation:spin 1s linear infinite"></i>در حال بارگذاری...</div>
  </div>
  <div class="footer">ارتباط: <a href="https://t.me/pshaka123" target="_blank">@</a> · Pshtiwan Gateway v9.2</div>
</div>
<script>
